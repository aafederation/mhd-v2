export const Card = () => {
  return (
    <template id="searchResultCard">
      <section
        className="[ radius ] tf-filter-item tf-item"
        data-tag=""
        data-service=""
      ...
      >
        <div
          className="text-400 pad-top-500 pad-bottom-500 pad-left-500 pad-right-500 split-pair"
          id="provider-header"
        >
          <div>
            <h3 className="link-pointer-basic"></h3>
            <h5 className="b-legal provider-type"></h5>
          </div>
          ...
          <div className="flow" style="--flow-space:0.5rem">
            ...
            <div className="display-flex" id="clinical-services-row">
              ...
              <div>
                ...
                <span className="weight-bold"></span>:
